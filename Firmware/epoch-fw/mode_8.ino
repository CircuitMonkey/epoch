...
uint8_t mode_8_4_cycle = 0;  // in ticks 0 - 64
#define MODE_8_4_CYC_MAX 63
//#define MODE_8_4_CYC_MIN 12

float mode_8_5_cycle = 0.0;  // in Radians 0 - 6.283
#define MODE_8_5_CYC_MAX 63
#define MODE_8_5_CYC_MIN 8
...
void mode_8_4_update_motors() {  // Plunge
  ...
  //if (m_8_4_slider[3].getVal() >= 0) {
    adv = m_8_4_slider[3].getVal() + 1; // 1 - 8
  //} 
  mode_8_4_cycle += adv;

  if (mode_8_4_cycle > MODE_8_4_CYC_MAX) {
    mode_8_4_cycle = 0;
  }

  uint16_t phase = mode_8_4_cycle/(MODE_8_4_CYC_MAX/5); // 63/11 == 5-ish phases.
  ...
  switch ( phase ) {
    case 0: // Motor pair 1/2
      mot0 = m_8_4_slider[0].getVal(); // front motor
      break;
    case 1: // Motor pair 3/4
      mot1 = m_8_4_slider[0].getVal(); // front motor
      break;
    case 2: // Motor pair 5/6
      mot2 = m_8_4_slider[1].getVal(); // mid motor
      break;
    case 3: // Motor 7
      mot3 = m_8_4_slider[2].getVal(); // mid motor
      break;
    case 4: // Motor 8
      mot4 = m_8_4_slider[2].getVal(); // back motor
      break;
...
void mode_8_5_update_motors() {  // Draw
  uint8_t adv;
  adv = m_8_5_slider[3].getVal() + 1;
  mode_8_5_cycle += adv;

  if (mode_8_5_cycle > MODE_8_5_CYC_MAX) {
    mode_8_5_cycle = 0;
  }

  uint16_t phase = mode_8_5_cycle/(MODE_8_5_CYC_MAX/5); // 63/11 == 5-ish phases.
  Serial.printf("Phase: %d\n", phase);
  ...
  switch ( phase ) { // Like plunge but CASEs are reversed.
    case 4: // Motor pair 1/2
      mot0 = m_8_5_slider[0].getVal(); // front motor
      break;
    case 3: // Motor pair 3/4
      mot1 = m_8_5_slider[0].getVal(); // front motor
      break;
    case 2: // Motor pair 5/6
      mot2 = m_8_5_slider[1].getVal(); // mid motor
      break;
    case 1: // Motor 7
      mot3 = m_8_5_slider[2].getVal(); // mid motor
      break;
    case 0: // Motor 8
      mot4 = m_8_5_slider[2].getVal(); // back motor
      break;
    default: // dwell, motors off
      break;
  }
